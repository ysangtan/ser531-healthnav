...
import { useHospitalsWithFallback } from "@/lib/dataProvider";
import { ErrorState } from "@/components/ui/ErrorState";

export default function Hospitals() {
  const { data: hospitals, isLoading, error, usingMockData } = useHospitalsWithFallback();
    ...
    <div className="p-4 lg:p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          {isLoading ? "Loading hospitals..." : "Explore hospitals with quality scores and affiliations."}
